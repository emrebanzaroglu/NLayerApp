    ...
    public class ProductSeed : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            builder.HasData(
                ...
                new Product(){Id=4, Name= "Kitap 1", CategoryId=2, Price=400, Stock=34, CreatedDate= DateTime.Now},
                new Product(){Id=5, Name= "Kitap 2", CategoryId=2, Price=500, Stock=23, CreatedDate= DateTime.Now}
            );
        }
    }
}
